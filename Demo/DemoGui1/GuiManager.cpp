...
protected:
	...
	void LoadRes()
	{
		...
		REG_IMG(banner, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\corner_lb.png"));
		REG_IMG(corner_lb, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\corner_rb.png"));
		REG_IMG(corner_rb, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\corner_rt.png"));
		REG_IMG(corner_rt, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\corner_lt.png"));
		REG_IMG(corner_lt, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\line_bottom.png"));
		REG_IMG(line_bottom, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\line_left.png"));
		REG_IMG(line_left, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\line_right.png"));
		REG_IMG(line_right, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\line_top.png"));
		REG_IMG(line_top, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\tag_bg.png"));
		REG_IMG(tag_bg, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\toolbar_bg.png"));
		REG_IMG(toolbar_bg, gcnew(gc, CImage))->Set(coder->Decode());

		file.Open(path + _T("\\list.png"));
		REG_IMG(list, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_cor_lt.png"));
		REG_IMG(list_cor_lt, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_item_top.png"));
		REG_IMG(list_item_top, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_cor_rt.png"));
		REG_IMG(list_cor_rt, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_item_left.png"));
		REG_IMG(list_item_left, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_item.png"));
		REG_IMG(list_item, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_item_right.png"));
		REG_IMG(list_item_right, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_cor_lb.png"));
		REG_IMG(list_cor_lb, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_item_bottom.png"));
		REG_IMG(list_item_bottom, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_cor_rb.png"));
		REG_IMG(list_cor_rb, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_lt.png"));
		REG_IMG(list_foc_lt, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_top.png"));
		REG_IMG(list_foc_top, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_rt.png"));
		REG_IMG(list_foc_rt, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_left.png"));
		REG_IMG(list_foc_left, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc.png"));
		REG_IMG(list_foc, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_right.png"));
		REG_IMG(list_foc_right, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_lb.png"));
		REG_IMG(list_foc_lb, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_bottom.png"));
		REG_IMG(list_foc_bottom, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\list_foc_rb.png"));
		REG_IMG(list_foc_rb, gcnew(gc, CImage))->Set(coder->Decode());
		LoadDirImage(list_ico, list_str, path + _T("\\icon"), coder, &gc);

		file.Open(path + _T("\\scr_h_bg.png"));
		REG_IMG(scr_h, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\scr_h_sli_top.png"));
		REG_IMG(scr_h_sli_top, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\scr_h_sli_bottom.png"));
		REG_IMG(scr_h_sli_bottom, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\scr_h_sli.png"));
		REG_IMG(scr_h_sli, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\scr_h_ico.png"));
		REG_IMG(scr_h_ico, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\scr_h_up.png"));
		REG_IMG(scr_h_up, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\scr_h_dn.png"));
		REG_IMG(scr_h_dn, gcnew(gc, CImage))->Set(coder->Decode());

		file.Open(path + _T("\\win_sysbtn_close.png"));
		REG_IMG(win_sysbtn_close, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\win_sysbtn_max.png"));
		REG_IMG(win_sysbtn_max, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\win_sysbtn_min.png"));
		REG_IMG(win_sysbtn_min, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\win_sysbtn_restore.png"));
		REG_IMG(win_sysbtn_restore, gcnew(gc, CImage))->Set(coder->Decode());

		file.Open(path + _T("\\topbar_btn.png"));
		REG_IMG(topbar_btn, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\gamesearch_charmap.png"));
		REG_IMG(gamesearch_charmap, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\toolbar_tools.png"));
		REG_IMG(toolbar_tools, gcnew(gc, CImage))->Set(coder->Decode());

		file.Open(path + _T("\\tag_qb.png"));
		REG_IMG(tag_qb, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\tag_zx.png"));
		REG_IMG(tag_zx, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\tag_wl.png"));
		REG_IMG(tag_wl, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\tag_dz.png"));
		REG_IMG(tag_dz, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\tag_wy.png"));
		REG_IMG(tag_wy, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\tag_dj.png"));
		REG_IMG(tag_dj, gcnew(gc, CImage))->Set(coder->Decode());

		file.Open(path + _T("\\search_bg.png"));
		REG_IMG(search_bg, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\search_button.png"));
		REG_IMG(search_button, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\google_bg.png"));
		REG_IMG(google_bg, gcnew(gc, CImage))->Set(coder->Decode());
		file.Open(path + _T("\\google_button.png"));
		REG_IMG(google_button, gcnew(gc, CImage))->Set(coder->Decode());
	}
